...
//
//     final randomUserResponseModel = randomUserResponseModelFromJson(jsonString);

import 'dart:convert';

RandomUserResponseModel randomUserResponseModelFromJson(String str) => RandomUserResponseModel.fromJson(json.decode(str));

String randomUserResponseModelToJson(RandomUserResponseModel data) => json.encode(data.toJson());
...
class RandomUserResponseModel {
  ...
  factory RandomUserResponseModel.fromJson(Map<String, dynamic> json) => RandomUserResponseModel(
